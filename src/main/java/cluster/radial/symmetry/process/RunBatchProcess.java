...
public class RunBatchProcess {
	...
	public static void runProcessImage(File pathMedian, File pathMask, File pathZcorrected, File pathResultCsvBeforeCorrection, File pathParameters, File pathResultCsv, boolean doZcorrection) {
		...
		if (pathMedian.exists()){
			...
			GUIParams params = ParametersFirstRun.getSEA12ParametersFirstRun(670);
			BatchProcess.process(pathMedian, pathMask, params, pathResultCsvBeforeCorrection, pathParameters, pathZcorrected, pathResultCsv, doZcorrection);
		}
		else {
