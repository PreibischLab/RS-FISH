...
public class RunBatchProcess {
	...
	public static void runProcessImage(File pathMedian, File pathMask, File pathZcorrected, File pathResultCsvBeforeCorrection, File pathParameters, File pathResultCsv, boolean doZcorrection, int waveLength) {
