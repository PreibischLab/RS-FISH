...
/**
 * Radial Symmetry Package This software is free software: you can redistribute
...
public class LocalMaximaNeighborhood extends LocalMaxima {
	...
	public LocalMaximaNeighborhood(
	...
	public LocalMaximaNeighborhood(
		final RandomAccessibleInterval<FloatType> source, final double threshold)
	{
		super(source);
	...
	public ArrayList<int[]> estimateLocalMaxima() {
		...
		final RandomAccessibleInterval<FloatType> area = Views.interval(source,
			interval);
		...
		for (final Neighborhood<FloatType> localNeighborhood : shape.neighborhoods(
			area))
		{
