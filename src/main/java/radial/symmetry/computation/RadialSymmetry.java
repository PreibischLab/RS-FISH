package radial.symmetry.computation;
...
import gradient.normalized.computation.NormalizedGradientAverage;
import gradient.normalized.computation.NormalizedGradientMedian;
