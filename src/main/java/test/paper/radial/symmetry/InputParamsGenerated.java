...
public class InputParamsGenerated {
	...
	public InputParamsGenerated(String localPath, int type) {
		// type = 0, 2D image
		// type = 1, 3D image
		if (type == 0) {
			// input data params
			path = localPath.equals("")
					? "/Users/kkolyva/Desktop/2018-02-21-paper-radial-symmetry-test/"
						: localPath;
			...
			path = localPath.equals("")
					? "/Users/kkolyva/Desktop/2018-02-21-paper-radial-symmetry-test/"
						: localPath;
			imgName = "test-3D-image";
			posName = "test-3D-pos";
			dims = new long[] { 512, 512, 128};
			sigma = new double[] { 3, 3, 3};
			numDimensions = dims.length;
			numSpots = 800;
			seed = 42;
			padding = true;
